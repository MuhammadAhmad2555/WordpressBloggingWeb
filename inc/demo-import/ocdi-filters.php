...
function csco_ocdi_plugin_page_setup( $default_settings ) {
	$data = array(
		...
		'page_title'  => esc_html__( 'Demo Content', 'the-affair' ),
		'menu_title'  => esc_html__( 'Demo Content', 'the-affair' ),
		'capability'  => 'import',
...
function csco_ocdi_page_title() {
	return '<div class="ocdi__title-container"><h1 class="ocdi__title-container-title">' . esc_html__( 'Demo Content Import', 'the-affair' ) . '</h1></div>';
}
...
function csco_ocdi_plugin_intro_text( $default_text ) {
	...
	<div class="ocdi__intro-text">
		<p class="about-description"><?php esc_html_e( 'Clicking the Import Demo Data button will import demo posts, pages, categories, comments, tags and widgets.', 'the-affair' ); ?></p>
	</div>
	<?php
