...
if ( class_exists( 'WooCommerce' ) ) {
	...
	function csco_wc_add_fields_customizer() {
		CSCO_Kirki::add_section(
			...
			array(
				'title'    => esc_html__( 'Common Settings', 'the-affair' ),
				'panel'    => 'woocommerce',
				'priority' => 1,
			)
		);
		...
		CSCO_Kirki::add_field(
			...
			array(
				...
				'label'    => esc_html__( 'Default Page Sidebar', 'the-affair' ),
				'section'  => 'woocommerce_common_settings',
				'default'  => 'disabled',
				'priority' => 10,
				'choices'  => array(
					'right'    => esc_html__( 'Right Sidebar', 'the-affair' ),
					'left'     => esc_html__( 'Left Sidebar', 'the-affair' ),
					'disabled' => esc_html__( 'No Sidebar', 'the-affair' ),
				),
			)
		);
